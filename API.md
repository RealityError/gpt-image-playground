...
- `quality`: optional, forwarded as-is to the upstream API.

Other advanced fields are accepted by the request model for compatibility but are not forwarded upstream.
